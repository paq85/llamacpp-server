...
> **Read the write-up.** [A 27B Coding Agent That Runs on 16 GB VRAM](https://www.damiansromek.pl/en/tech/blog/local-llm-copilot-backend/) — a blog post walking through this setup end to end: the architecture, the Qwen 3.8 reliability tweaks, the 16 GB / 32 GB profiles, and how it's wired into VS Code Copilot.
